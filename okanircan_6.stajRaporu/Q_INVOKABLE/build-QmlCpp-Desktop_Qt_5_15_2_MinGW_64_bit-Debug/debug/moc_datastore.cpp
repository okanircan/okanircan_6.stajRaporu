...
QT_MOC_LITERAL(3, 26, 13), // "callMeFromQml"
QT_MOC_LITERAL(4, 40, 14), // "qInvokeExample"
QT_MOC_LITERAL(5, 55, 3), // "str"
QT_MOC_LITERAL(6, 59, 7) // "message"

    },
    "datastore\0messageChanged\0\0callMeFromQml\0"
    "qInvokeExample\0str\0message"
};
...
void datastore::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: { int _r = _t->qInvokeExample((*reinterpret_cast< QString(*)>(_a[1])));
        ...
        {
            using _t = void (datastore::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&datastore::messageChanged)) {
                *result = 0;
                return;
            }
        }
